...
| WIP-V1-A6     | <date>   | <cmmt>  | HDMI flicker-free menu toggle (issue #12). Added official aexp_screen.cfg with great known-to-work default values. Unmount ADFs by pressing SPACE (issue #16).
