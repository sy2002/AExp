...
| WIP-V1-A6     | <date>   | <cmmt>  | HDMI flicker-free (issue #12). Battery-buffered clock (13). Added official aexp_screen.cfg with great known-to-work default values. Unmount ADFs by pressing SPACE (issue #16). Fixed F-key issues (#9 and #10).
